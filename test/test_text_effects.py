...
def basic_font_test_cases():
    return [
        ...
        (
            ['effects', ['font', ['size', '2.0', '1.5'], ['thickness', '0.2'], 'bold', 'italic']],
...
def justify_test_cases():
    return [
        ...
        (
            ...
            TextEffects(font=Font(), justify_horizontal="left", justify_vertical="bottom", mirror=True)
        ),
    ]
...
@pytest.mark.parametrize("sexp,expected_error", [
