...
from models import Footprint, Property, Polygon, Line, Pad, Layer, Point, Stroke, FontEffects, Points
from typing import List, Dict, Any, Tuple

footprint_root = Path("~/Downloads/SparkFun_dToF-TMF8820_v10/SparkFun_dToF-TMF8820/SparkFun_dToF-TMF8820.pretty").expanduser()
